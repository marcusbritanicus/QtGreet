...
static void keyboard_handle_modifiers( struct wl_listener *listener, void * ) {
...
static void process_cursor_move( struct tinywl_server *server, uint32_t ) {
...
static void process_cursor_resize( struct tinywl_server *server, uint32_t ) {
    /*
...
static void server_cursor_frame( struct wl_listener *listener, void * ) {
...
static void output_frame( struct wl_listener *listener, void * ) {
...
static void xdg_toplevel_map( struct wl_listener *listener, void * ) {
...
static void xdg_toplevel_unmap( struct wl_listener *listener, void * ) {
...
static void xdg_toplevel_destroy( struct wl_listener *listener, void * ) {
...
static void xdg_toplevel_request_move( struct wl_listener *listener, void * ) {
